...
const resolvers = {
  Query: {
    ...
    allBooks: (root, args) => {
      ...
      if (args.genre && args.author) {
        const authBooks = books.filter((b) => b.author === args.author);
        return authBooks.filter((b) => b.genres.includes(args.genre));
      } else if (!args.genre) {
  ...
  Mutation: {
    ...
    editAuthor: (root, args) => {
      ...
      authors = authors.map((a) => (a.name === args.name ? newAuth : a));
      return newAuth;
    },
  },
};
